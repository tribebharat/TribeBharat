...
const Men = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true)
        const data = await products.getAll({ category: 'Men' })
    ...
    <div className="min-h-screen pt-20 bg-white">
      ...
      <div className="bg-surface py-16 mb-8">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-primary mb-4">Bespoke Menswear</h1>
          <p className="text-gray-500 max-w-2xl mx-auto">Discover our latest collection of handcrafted menswear, designed for the modern gentleman who values tradition.</p>
        </div>
      </div>
